...
from dodp_new.tests.texts import text_1, text_2, text_3
...
tag_info_list_by_params_test_pairs = [
    (
        'Test',
        text_1,
        {'TestType': 'CM'},
